...
void prisma(float dimX,float dimY,float dimZ)//se declaran varibles para X, Y y Z  que multiplicarán las dimensiones del prisma unitario, haciéndo
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glLoadIdentity();
		...
		//Poner Código Aquí.
	glRotatef(angleY,1,1,0);//se cambia el valor del angulo fijo, por una variable  ya definida como "angle Y" y se activa en 1 el  eje sobre el
	//que se hará la rotacioon
